...
% Last Modified by GUIDE v2.5 15-Oct-2020 19:01:42
...
Iprops=regionprops(im,'BoundingBox','Area', 'Image'); %measure properties of image region
area = Iprops.Area;
count = numel(Iprops); %calculate the number of array elements
maxa= area;
